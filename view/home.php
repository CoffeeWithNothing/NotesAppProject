...
<nav class="d-flex flex-wrap align-items-center px-4 justify-content-center justify-content-sm-start" style="height: 100px;">
    ...
    <div class="ms-auto d-flex align-items-center">
        ...
        <button type="button"
            ...
            class="btn btn-outline-light btn-sm text-nowrap d-none d-md-inline mb-4 text-btn fw-semibold fs-6">
        ...
        <a href="userProfile.php" class="mb-4 text-decoration-none mx-3 text-white btn btn-outline-light btn-sm text-nowrap d-none d-md-inline text-btn mb-4 fw-semibold fs-6">Ajustes</a>
