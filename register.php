...
<nav class="d-flex flex-wrap align-items-center bg-dark px-4 justify-content-center justify-content-sm-start" style="height: 85px;">
    <!-- Logo Section -->
    <a href="register.php" aria-label="Bunnotes" class="d-flex align-items-center flex-shrink-0 me-3">
        <img src="images/icon.png" alt="Bunnotes Logo" style="width: 120px; height: 120px; object-fit: contain; margin-top: -18px;">
    </a>
    ...
    <div class="d-flex align-items-center flex-grow-1 justify-content-center justify-content-sm-start">
        ...
        <!-- Separator -->
        <div role="separator" class="border-end border-light mx-4 d-none d-sm-inline mb-4" style="height: 45px;"></div>

        <!-- Language Selector (hidden < sm) -->
        <!-- lang-btn is my class inside the css  -->
        <button type="button"
            aria-haspopup="dialog"
            aria-expanded="false"
            aria-label="Idioma: Español"
            class="btn btn-outline-light btn-sm text-nowrap d-none d-sm-inline mb-4 text-btn fw-semibold">
            Español (España)
        ...
        <a href="registro.php" class="mb-4 text-decoration-none mx-4 text-white btn btn-outline-light btn-sm text-nowrap d-none d-sm-inline text-btn mb-4 fw-semibold">Iniciar Sesión</a>
    </div>
        ...
        <div class="col-12 col-md-8 col-lg-6"> <!-- Responsive width -->
                <div class="card-body p-4 p-md-5 bg-dark"> <!-- Responsive padding -->
                    ...
                    <form action="register.php" method="post" novalidate>
                        ...
                        <!-- Username Field -->
                        <!-- The regex does work, but only in client, so make another in phhp  -->
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit"
                                    class="btn btn-primary btn-sm w-100 w-md-50"
