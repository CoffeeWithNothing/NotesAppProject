...
<nav class="d-flex flex-wrap align-items-center bg-dark px-4 justify-content-center justify-content-sm-start" style="height: 100px;">
    <!-- Logo Section -->
    ...
    <div class="ms-auto d-flex align-items-center">
        ...
        <a href="userProfile.php" class="mb-4 text-decoration-none me-3 text-white btn btn-outline-light btn-sm text-nowrap d-none d-md-inline text-btn mb-4 fw-semibold">Cerrar Sesión</a>
